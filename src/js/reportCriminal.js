export default {
  methods: {
    ...
    validateEmptyInputs: function(
      ...
      if (
        !validationRule.test(coloniaWhiteSpaces) ||
        !validationRule.test(calleWhiteSpaces)
      ) {
    ...
    validateDescriptionWhiteSpaces: function(data) {
      var descriptionhiteSpaces = data.split(" ").join("");
      var validationRule = /^\S{3,}$/;

      if (!validationRule.test(descriptionhiteSpaces)) {
        return true;
      }
      return false;
    },
    ...
    createNoticeMessage: function(value) {
      ...
      switch (value) {
        ...
        case 5:
          ...
          break;
        default:
          this.imputSearchMsm = "Error on value";
          break;
      }
    },
    ...
    validateAddress: function(colonia, calle) {
      ...
      if (invalidColinia != null || invalidCalle != null) {
        this.dismissCountDown = this.dismissSecs;
        this.imputSearchMsm = "Debe ingresar una direccion o colonia, validos";
        return true;
      }
      return false;
    },
    ...
    referenceVerification: function(referencia = "google.com") {
      if (!isNaN(referencia)) {
        this.inputMsm = "Debe ingresar  url valido para continuar";
        return false;
      }
      ...
      if (
        (result
          .toString()
          .toLowerCase()
          .includes("zetatijuana") ||
          result
            .toString()
            .toLowerCase()
            .includes("elsoldetijuana") ||
          result
            .toString()
            .toLowerCase()
            .includes("tijuanainformativo") ||
          result
            .toString()
            .toLowerCase()
            .includes("elimparcial") ||
          result
            .toString()
            .toLowerCase()
            .includes("alfredoalvarez") ||
          result
            .toString()
            .toLowerCase()
            .includes("afntijuana") ||
